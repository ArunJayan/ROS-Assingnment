...
set(MSG_I_FLAGS "-Iperformance_tests:/home/arunjayan/assignment_workspace/src/performance_tests/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/arunjayan/assignment_workspace/src/performance_tests/msg/SuperAwesome.msg" NAME_WE)
add_custom_target(_performance_tests_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "performance_tests" "/home/arunjayan/assignment_workspace/src/performance_tests/msg/SuperAwesome.msg" ""
)
...
_generate_msg_cpp(performance_tests
  "/home/arunjayan/assignment_workspace/src/performance_tests/msg/SuperAwesome.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/performance_tests)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/performance_tests\")")
  # install generated code
  install(
